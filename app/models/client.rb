class Client < ApplicationRecord
  ...
  has_many :client_has_conjoints, inverse_of: :client
  has_many :conjoints, through: :client_has_conjoints, :class_name => 'Client'
  ...
  accepts_nested_attributes_for :conjoints, :reject_if => :all_blank, :allow_destroy => true
